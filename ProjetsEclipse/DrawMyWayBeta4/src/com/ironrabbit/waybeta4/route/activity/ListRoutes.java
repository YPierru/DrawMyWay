package com.ironrabbit.waybeta4.route.activity;
...
import com.ironrabbit.waybeta4.gps.activity.GPSRunner;
import com.ironrabbit.waybeta4.route.Route;
import com.ironrabbit.waybeta4.route.RouteAdapter;
import com.ironrabbit.waybeta4.route.RoutesCollection;
...
public class ListRoutes extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * Ici, on r??cup??re le typeCurrentRoute par un intent. On le fait dans
		 * un try catch, si ??a passe par le catch, on met un typeCurrentRoute
		 * par d??faut (VOITURE ou COUREUR, osef)
		 */
		try {
