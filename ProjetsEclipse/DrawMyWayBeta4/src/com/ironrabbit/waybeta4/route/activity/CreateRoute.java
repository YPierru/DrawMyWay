...
import com.ironrabbit.waybeta4.PlaceJSONParser;
import com.ironrabbit.waybeta4.R;
import com.ironrabbit.waybeta4.asyncTasks.GettingRoute;
...
public class CreateRoute extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Action si montrajet reu est en cours
	...
	public class WheelMenu implements RadialMenuEntry {
		...
		public void actionCorrection() {
			if (!correctionEnable) {
				...
				CreateRoute.getInstance().getActionBar().setSubtitle("");
				if (mPolyline != null) {
					mPolyline.remove();
				}
